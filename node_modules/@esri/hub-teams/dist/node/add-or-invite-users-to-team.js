...
exports.addOrInviteUsersToTeam = void 0;
...
async function addOrInviteUsersToTeam(groupId, users, primaryRO, canAutoAddUser, addUserAsGroupAdmin, email) {
    ...
    const parsedUsers = utils_1.groupUsersByOrgRelationship(users);
    ...
    const result = {
        community: await utils_1.addOrInviteCommunityUsers(context),
        org: await utils_1.addOrInviteOrgUsers(context),
        world: await utils_1.addOrInviteWorldUsers(context),
        partnered: await utils_1.addOrInvitePartneredUsers(context),
        collaborationCoordinator: await utils_1.addOrInviteCollaborationCoordinators(context),
        notAdded: [],
        notInvited: [],
        notEmailed: [],
        errors: [],

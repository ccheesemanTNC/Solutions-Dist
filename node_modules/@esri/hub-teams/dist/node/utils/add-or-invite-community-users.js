...
exports.addOrInviteCommunityUsers = void 0;
...
async function addOrInviteCommunityUsers(context) {
    ...
    let fnToCall = handle_no_users_1.handleNoUsers;
    ...
    if (context.community && context.community.length > 0) {
        ...
        fnToCall = context.canAutoAddUser
            ? process_auto_add_users_1.processAutoAddUsers
            : process_invite_users_1.processInviteUsers;
        ...
        if (context.email) {
            ...
            if (context.email.hasOwnProperty("groupId")) {
                ...
                if (context.email.groupId === context.groupId) {
                    ...
                    fnToCall = process_auto_add_users_1.processAutoAddUsers;
                    shouldEmail = true;
...
//# sourceMappingURL=add-or-invite-community-users.js.map
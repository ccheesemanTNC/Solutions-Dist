...
import { IUpdateGroupUsersResult } from "@esri/arcgis-rest-portal";
/**
 ...
 */
export declare function updateUserMembership(id: string, users: string[], newMemberType: "member" | "admin", authentication: UserSession): Promise<IUpdateGroupUsersResult>;

...
export declare type AGOAccess = "public" | "org" | "private";
/**
 * Hub Product Enum
 ...
 */
export declare type HubProduct = "basic" | "premium" | "portal";
export declare type HubTeamType = typeof TEAMTYPES[number];
/**
 * Group Template
 ...
 */
export declare const TEAMTYPES: readonly ["core", "content", "followers", "team", "event", "edit"];

...
import { IConsolidatedResult, IEmail, IHubRequestOptions } from "@esri/hub-common";
/**
 ...
 */
export declare function addUsersToTeam(teamId: string, usersToAdd: IUser[], primaryRO: IHubRequestOptions, email?: IEmail, secondaryRO?: IHubRequestOptions): Promise<IConsolidatedResult>;

...
function updateServiceDefinition(url, requestOptions) {
    var adminUrl = arcgis_rest_request_1.cleanUrl(url).replace("/rest/services", "/rest/admin/services") + "/updateDefinition";
    requestOptions.params = tslib_1.__assign({ updateDefinition: {} }, requestOptions.params);

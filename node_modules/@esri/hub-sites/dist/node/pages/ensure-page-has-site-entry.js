...
exports.ensurePageHasSiteEntry = void 0;
...
function ensurePageHasSiteEntry(siteModel, pageModel) {
    ...
    const parentInitiativeId = hub_common_1.getProp(siteModel, "item.properties.parentInitiativeId");
    // swap initiativeId to siteId
    // for a period of time, this happened during Solution generation
    if (parentInitiativeId) {
        const currentSites = hub_common_1.getProp(pageModel, "data.values.sites");

...
define(["require", "exports", "@esri/solution-creator", "@esri/solution-deployer"], function (require, exports, creator, deployer) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.implementedTypes = void 0;
    function implementedTypes() {
        let html = "<h3>AGO types implemented or being worked on as of " +
            new Date().toString() +
            "</h3>";
        ////////////////////////////////////////////////////////
        // Layer types
    ...
    exports.implementedTypes = implementedTypes;
    function getImplementedTypes(title, typeNames) {
        let html = "<h4>" + title + "</h4>";
        html += "<ul>";
        typeNames.forEach(typeName => {
            const createable = creator.moduleMap[typeName];
            const deployable = deployer.moduleMap[typeName];
            if (typeof createable !== "undefined" &&
                createable !== null &&
...
//# sourceMappingURL=implemented-types-main.js.map